...
public class PredefineClass {
	...
	public static void SendTextbox(WebElement element, String testData) {
	...
	public static void TakescreenShort(String path) throws IOException {
